...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container">
        <form class="mb-5" action="<?php echo e(route('review.update', $data->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_client" name="nama_client"
                                    placeholder="Nama Client" autofocus required value="<?php echo e($data->nama_client); ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control rich-text-editor" id="review" name="review"
                                    required><?php echo e($data->review); ?></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="icon" class="form-label fw-bolder">Cover:</label>
                                <img src="<?php echo e(url('storage/'.$data->foto)); ?>" class="rounded d-block img-fluid"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ProjectX\makna-design\resources\views/admin/review/edit.blade.php ENDPATH**/ ?>