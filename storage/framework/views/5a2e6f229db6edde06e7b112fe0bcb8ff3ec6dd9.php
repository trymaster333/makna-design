...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container">
        <div class="col-sm-9">
            ...
            <div class="row">
                <form class="mb-5" action="<?php echo e(route('kontak.update', $data->id)); ?>" method="POST"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Nama Kontak"
                                value="<?php echo e($data->judul); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="kontak" class="form-label fw-bolder">Kontak / Username:</label>
                            <input type="text" class="form-control" id="kontak" name="kontak"
                                placeholder="Username/Nomor HP" value="<?php echo e($data->kontak); ?>" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="link" name="link" placeholder="https://..."
                                value="<?php echo e($data->link); ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="icon" class="form-label fw-bolder">Icon:</label>
                            <img src="<?php echo e(url('storage/'.$data->icon)); ?>" class="rounded d-block img-fluid"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ProjectX\makna-design\resources\views/admin/kontak/edit.blade.php ENDPATH**/ ?>