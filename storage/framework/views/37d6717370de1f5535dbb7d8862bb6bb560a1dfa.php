...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container">
        <form class="mb-5" action="<?php echo e(route('paket-harga.update', $data->id)); ?>" method="POST"
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="judul" name="judul" placeholder="Nama Paket"
                                    autofocus required value="<?php echo e($data->judul); ?>">
                            </div>
                            <div class="mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" id="harga" name="harga"
                                            placeholder="Rp." required value="<?php echo e($data->harga); ?>">
                                    </div>
                                    <div class="col-sm-5">
                                        <select class="form-select" name="satuan" aria-label="Default select example">
                                            <option selected>-</option>
                                            <option value="/M2 Bangunan" <?php if($data->satuan == '/M2 Bangunan'): echo 'selected'; endif; ?>>/M2
                                                Bangunan</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control rich-text-editor" id="deskripsi"
                                    name="deskripsi"><?php echo e($data->deskripsi); ?></textarea>
                            </div>
...
<script>
    ...
    document.getElementById('harga').value="<?php echo e($data->harga); ?>";
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ProjectX\makna-design\resources\views/admin/paket-harga/edit.blade.php ENDPATH**/ ?>