...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container">
        <div class="col-sm-9">
            ...
            <div class="row">
                <form class="mb-5" action="<?php echo e(route('konsep-desain.update', $data->id)); ?>" method="POST"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="judul" name="judul" placeholder="Nama Kontak" value="<?php echo e($data->judul); ?>" required>
                        </div>
                        <div class="mb-3">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ProjectX\makna-design\resources\views/admin/konsep-desain/edit.blade.php ENDPATH**/ ?>