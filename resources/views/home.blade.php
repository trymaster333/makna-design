        ...
        <div class="container">
            ...
            <div class="tab-content">
                <div class="tab-pane container active" id="home">
                    @forelse ($projek_sekarang as $item)
                    <div class="card text-center my-2">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    <p class="card-text"><i data-feather="calendar"></i>{{$item->tanggal}}</p>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-4">
                                    <p class="card-text"><i data-feather="map-pin"></i>{{$item->lokasi}}</p>
                                </div>
                                <div class="col-sm-4">
                                    <p class="card-text"><i data-feather="home"></i>{{$item->tipe}}</p>
                                </div>
                                <div class="col-sm-4">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-stretch mb-5">
                    <div class="card" data-background-image="{{ url('storage/'.$item->cover) }}"
                        ...
                        <div class="col-md-3 mb-5">
                            <div class="custom-control custom-checkbox image-checkbox">
                                ...
                                <label class="custom-control-label" for="ck1a">
                                    <img src="{{asset('images/industrial.jpg')}}" alt="#" class="img-fluid">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-5">
                            <div class="custom-control custom-checkbox image-checkbox">
                                ...
                                <label class="custom-control-label" for="ck1b">
                                    <img src="{{asset('images/minimalis.jpg')}}" alt="#" class="img-fluid">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-5">
                            <div class="custom-control custom-checkbox image-checkbox">
                                ...
                                <label class="custom-control-label" for="ck1c">
                                    <img src="{{asset('images/kontemporer.jpg')}}" alt="#" class="img-fluid">
                                </label>
                            </div>
                        </div>
                        <div class="col-md-3 mb-5">
                            <div class="custom-control custom-checkbox image-checkbox">
                                ...
                                <label class="custom-control-label" for="ck1d">
                                    <img src="{{asset('images/tropis.jpg')}}" alt="#" class="img-fluid">
                                </label>
                            </div>
                        </div>
                    </div>
