...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container">
        <div class="col-sm-9">
            ...
            <div class="row">
                <form class="mb-5" action="{{ route('kontak.update', $data->id) }}" method="POST"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kontak" name="kontak"
                                placeholder="Username/Nomor HP" value="{{ $data->kontak }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ url('storage/'.$data->icon) }}" class="rounded d-block img-fluid"
