...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <div class="container">
        <form class="mb-5" action="{{ route('about.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                ...
                <div class="col-sm-2 fw-bolder">
                    Logo:
                    <img src="{{ url('storage/'.$data->image) }}" class="rounded mx-auto d-block img-fluid"
